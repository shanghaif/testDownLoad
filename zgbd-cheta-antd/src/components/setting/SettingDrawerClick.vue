  ...
  <div class="setting-drawer">
    ...
    >
      <div class="setting-drawer-index-content">
        ...
        <div :style="{ marginBottom: '24px' }">
          ...
          <div class="setting-drawer-index-blockChecbox">
            ...
            <a-tooltip>
              ...
              <div class="setting-drawer-index-item" @click="handleMenuTheme('hw')">
                <img src="/theme/hw/hw.svg" alt="light">
                <div class="setting-drawer-index-selectIcon" v-if="navTheme === 'hw'">
                  <a-icon type="check"/>
                </div>
              </div>
            </a-tooltip>
        ...
        <div :style="{ marginBottom: '24px' }">
          ...
          <div style="height: 20px;">
            <a-tooltip class="setting-drawer-theme-color-colorBlock" v-for="(item, index) in colorList" :key="index" style="margin: 5px;">
              <template slot="title">
                {{ item.key }}
              </template>
      ...
      <div class="setting-drawer-index-handle" @click="toggle"  v-if="!visible">
        <a-icon type="setting" title="个性化设置"/>
        个性化设置
      </div>-->
    </a-drawer>
  </div>
