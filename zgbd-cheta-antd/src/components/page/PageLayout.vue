<template>
  <div>
    ...
    <page-header v-if="!$route.meta.pageHeader" :title="title" :logo="logo" :avatar="avatar" ref="globalHeader">
...
<script>
  ...
  export default {
    ...
    methods: {
      getBread () {
        return this.$refs.globalHeader.breadList;
      },
      changeBread (breadList) {
        this.$refs.globalHeader.breadList = breadList;
      }
    }
  }
</script>
