    ...
    >
      ...
      <div v-else>
        ...
        >
          ...
          <a-list-item class="member-list-item cheta-event" slot="renderItem" slot-scope="item,index" v-else @click.native="checkPerson(item)">
            <a-list-item-meta>
...
<script>
  ...
  export default {
    ...
    data () {
      return {
        projectId: '78ba2ea790f4463e9b17a4575c9c3ccb',
        inviteStatus: false,
        linkStatus: false,
        keyword: '',
    ...
    methods: {
      ...
      ok () {
        ...
        if (!this.checkeds) {
          this.$emit('getUser',personList[0])
        } else {
          this.$emit('getUser',personList)
        }
        this.close()
