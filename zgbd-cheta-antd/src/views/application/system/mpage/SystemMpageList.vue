<template>
  <a-card :bordered="false">
    ...
    <!-- table区域-end -->
    <SystemMpage-modal ref="SystemMpageModal" @ok="modalFormOk"></SystemMpage-modal>

  </a-card>
</template>

<script>
  import SystemMpageModal from './modules/SystemMpageModal'
  ...
  export default {
    ...
    methods: {
      ...
      handleAdd(){
        this.$refs.SystemMpageModal.add();
        this.$refs.SystemMpageModal.title="新增";
      },
      handleEdit: function(record){
        this.$refs.SystemMpageModal.edit(record);
        this.$refs.SystemMpageModal.title="编辑";
      },
      handleDetail(record){
        this.$refs.SystemMpageModal.edit(record);
        this.$refs.SystemMpageModal.title="详情";
        this.$refs.SystemMpageModal.disableSubmit = true;
      },
      handleDelete(id){
        var that = this;
