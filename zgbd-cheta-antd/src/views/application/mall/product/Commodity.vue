<template>
  <div>
    ...
    <commodity-modal title="添加规格" :visible="visible" @ok="handleOk" @cancel="handleCancel" ref="commoditymodal">
    </commodity-modal>
  </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      handleAdd(){
        this.$refs.commoditymodal.add();
        this.$refs.commoditymodal.title="新增";
      },
      handleEdit: function(record){
        this.$refs.commoditymodal.edit(record);
        this.$refs.commoditymodal.title="编辑";
      },
      handleDetail(record){
        this.$refs.commoditymodal.edit(record);
        this.$refs.commoditymodal.title="详情";
        this.$refs.commoditymodal.disableSubmit = true;
      },
      handleDelete(id){
        var that = this;
