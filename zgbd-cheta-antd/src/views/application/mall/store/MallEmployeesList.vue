    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline">
        <a-row :gutter="24">
          ...
          <a-col :span="6">
            <a-form-item label="">
              <a-input placeholder="请输入店员姓名/手机号" v-model="queryParam.name"></a-input>
  ...
  export default {
    ...
    data () {
      return {
        ...
        selectedRows: [],
        url: {
          list: "/application/setting/employees/getEmployees",
