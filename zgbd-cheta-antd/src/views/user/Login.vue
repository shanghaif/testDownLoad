      ...
      <a-tabs
        ...
        <a-tab-pane key="tab1" tab="账号密码登陆">
          <a-form-item
            ...
            <a-input size="large" type="text" placeholder="请输入帐户名 / cheta">
          ...
          <a-form-item
            ...
            <a-input size="large" type="password" autocomplete="false" placeholder="密码 / cheta">
...
//        })
    ...
    methods: {
      ...
      handleSubmit () {
        ...
        if (that.customActiveKey === 'tab1') {
          that.form.validateFields([ 'username', 'password' ], { force: true }, (err, values) => {
            if (!err) {
              flag = true
              loginParams[!that.loginType ? 'email' : 'loginName'] = values.username
              //loginParams.password = md5(values.password)
              loginParams.password = values.password
              loginParams.loginType = 'PC'
            }
          })
        // 使用手机号登陆
        } else {
      ...
      loginSuccess () {
        ...
        // this.loginBtn = false
        // this.$router.push({ name: "/Car/Register" })
